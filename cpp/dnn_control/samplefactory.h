...
public:
    ...
    // semi_axis_[0] * cos(u) * sin(v) * min_scale < point[0] < semi_axis[0] * band_width_scale * cos(u) * sin(v) * max_scale
    // semi_axis_[1] * sin(u) * sin(v) * min_scale < point[1] < semi_axis[1] * band_width_scale * sin(u) * sin(v) * max_scale
    // semi_axis_[2] * cos(v) * min_scale          < point[2] < semi_axis[1] * band_width_scale * cos(v) * max_scale
