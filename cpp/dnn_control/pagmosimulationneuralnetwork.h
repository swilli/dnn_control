...
public:
    ...
    PaGMOSimulationNeuralNetwork(const unsigned int &random_seed, const std::set<SensorSimulator::SensorType> &control_sensor_types={}, const bool &control_with_noise=false, const std::set<SensorSimulator::SensorType> &recording_sensor_types={}, const bool &recording_with_noise=false, const bool &fuel_usage_enabled=true, const bool &initial_spacecraft_offset_enabled=true, const InitialSpacecraftVelocity &initial_spacecraft_velocity=InitialSpacecraftVelocity::BodyZeroVelocity, const std::map<SensorSimulator::SensorType, std::vector<std::pair<double, double> > > &sensor_value_transformations={});

    PaGMOSimulationNeuralNetwork(const unsigned int &random_seed, const unsigned int &hidden_nodes, const std::set<SensorSimulator::SensorType> &control_sensor_types={}, const bool &control_with_noise=false, const std::set<SensorSimulator::SensorType> &recording_sensor_types={}, const bool &recording_with_noise=false, const bool &fuel_usage_enabled=true, const bool &initial_spacecraft_offset_enabled=true, const InitialSpacecraftVelocity &initial_spacecraft_velocity=InitialSpacecraftVelocity::BodyZeroVelocity, const std::map<SensorSimulator::SensorType, std::vector<std::pair<double, double> > > &sensor_value_transformations={});
