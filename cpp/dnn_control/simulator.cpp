...
const SpacecraftController &spacecraft_controller, const double &control_frequency) :
    sensor_simulator_(sensor_simulator), spacecraft_controller_(spacecraft_controller), system_(ODESystem(asteroid, spacecraft_position, spacecraft_velocity, spacecraft_mass, EARTH_ACCELERATION * spacecraft_specific_impulse)),
