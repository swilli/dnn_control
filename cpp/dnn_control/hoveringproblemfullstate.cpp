...
double hovering_problem_full_state::single_post_evaluation(PaGMOSimulationFullState &simulation) const {
    double fitness = 0.0;
...
boost::tuple<std::vector<double>, std::vector<unsigned int> > hovering_problem_full_state::post_evaluate(const decision_vector &x, const unsigned int &start_seed, const std::vector<unsigned int> &random_seeds) const {
