...
std::vector<double> SensorSimulatorPartialState::Simulate(const SystemState &state, const Vector3D &height, const Vector3D &perturbations_acceleration, const double &time) {
    ...
    //[-0.13642254  1.99866286 -1.25111357 -2.33431525 -1.98000648  1.62025572], Stdevs: [ 113.81445591  295.40570589  365.77419862  591.33099245  303.92766693 276.30460142]

    const std::vector<std::pair<double, double> > mean_std_values = {
        {-0.13642254, 113.81445591},
        {1.99866286 , 295.40570589},
        {-1.25111357, 365.77419862},
        {-2.33431525, 591.33099245},
        {-1.98000648, 303.92766693},
        {1.62025572, 276.30460142}
    };
    for (unsigned int i = 0; i < 6; ++i) {
